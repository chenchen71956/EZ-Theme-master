...
/**
 * Format user info for ticket.
 * @param {object} userInfo User info object.
 * @param {object} ipInfo IP info object.
 * @param {object} [userSubscribe=null] User subscribe object.
 * @return {string} Formatted user info string.
 */
...
/**
 * Strip appended ticket user info block from message text.
 * @param {string} text Message text.
 * @return {string} Text without user info block.
 */
export function stripTicketUserInfoBlock(text) {
